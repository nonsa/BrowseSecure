...
"");DNTP.Config.setDisabledSitesReason(this.host,a);if(!this.docElement.url)this.docElement.url=this.parentDoc.defaultView.location.href;DNTP.reportIssue(a,this.docElement);if(this.docElement.abineAllowedSite)return DNTP.showPopupBlue(),DNTP.preventDefault.apply(DNTP,arguments);else this.show()}};View.registerDerivedClass(View.AllowedSites);